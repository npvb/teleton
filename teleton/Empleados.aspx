                ...
                <fieldset>
                    <ul class = "list">
                        <li class="field">
                             ...
                             <asp:Label ID="Label1" CssClass="label" runat="server" Text="ID"></asp:Label>
                             <asp:TextBox ID="txb_id" runat="server" Enabled="False" TabIndex="1" CssClass="txtbx_Empleado">0</asp:TextBox>
                        </li>
