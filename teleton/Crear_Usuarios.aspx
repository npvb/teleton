            ...
            <table class="style1">
                ...
                <tr>
                    ...
                    <td class="style10">
                        <table class="style1">
                            <tr>
                                <td class="style11">
                                    <asp:Button ID="btn_leftuserrol" runat="server" Text="&lt;" 
                                        onclick="btn_leftuserrol_Click" />
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                            <tr>
                                <td class="style11">
                                    <asp:Button ID="btn_rightuserrol" runat="server" Text="&gt;" 
                                        onclick="btn_rightuserrol_Click" />
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                ...
                <tr>
                    ...
                    <td class="style12">
                        &nbsp;</td>
                    <td class="style14">
                        <asp:Button ID="btn_GuardarUsuario" runat="server" Text="Guardar" 
                            Width="76px" onclick="btn_GuardarUsuario_Click" />
                    </td>
                    <td class="style16">
